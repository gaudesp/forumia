module ApplicationHelper
  ...
  def display_music(user)
    return "<iframe class='mt-2' id='popup-youtube-player' style='width:100%;height:400px' src='https://www.youtube.com/embed/#{VideoInfo.new(user.music).video_id}?enablejsapi=1&version=3&playerapiid=ytplayer&rel=0&autoplay=1' frameborder='0' allowfullscreen='true' allowscriptaccess='always'></iframe>".html_safe if user.music.present?
  end
