                ...
                var i = function() {
                    ...
                    return a.prototype.init = function() {
                        ...
                        if (!this.isBeenInitialized) {
                            this.htmlContent = document.createElement("div"), this.htmlContent.innerHTML = a.HTML_DIV_TEMPLATE, this.htmlContent.id = "", this.htmlContent.classList.add("hidden"), document.body.appendChild(this.htmlContent), this.htmlCloseButton = document.getElementById(a.HTML_CLOSE_BUTTON_ID), this.htmlStickerContainer = document.getElementById(a.HTML_STICKER_CONTAINER_ID);
                            try {
                        ...
                        try {
                            for (var o = v(t), s = o.next(); !s.done; s = o.next()) {
                                ...
                                this.htmlStickerContainer.innerHTML += '\n                <div class="risibank-sticker" data-dismiss="modal" data-link="' + l.risibank_link + '">\n                    <img src="' + c + '">\n                </div>\n            '
                            }
                        } catch (t) {
                            e = {
                                error: t
                    ...
                    }, a.HTML_CLOSE_BUTTON_ID = "risiclose", a.HTML_STICKER_CONTAINER_ID = "risibank-stickers", a.HTML_SEARCH_INPUT_ID = "risibank-search", a
                }();
                (n.View = i).HTML_DIV_TEMPLATE = '\n\n    <div class="modal fade" id="risibankModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="text-align: center!important"><div class="modal-dialog" role="document"><div class="modal-content"><div id="risibank-overlay">\n   <div class="modal-header"><div id="risibank-banner">\n            <img id="risibank-logo" src="https://risibank.fr/src/picts/banner-light.png">\n            <button type="button" class="close" id="' + i.HTML_CLOSE_BUTTON_ID + '" data-dismiss="modal" aria-label="Close"> <i class="fas fa-times"></i> </button>\n        </div></div>\n     <div id="' + i.HTML_STICKER_CONTAINER_ID + '">\n            \x3c!-- contains the actual stickers --\x3e\n        </div>\n         <div id="risibank-navigation">\n            \x3c!-- menu & links --\x3e\n         <ul class="nav nav-tabs" id="risinav">\n            \n                <li class="nav-item risibank-navigation" data-nav="search">\n                    <a onclick="hideRisitas();" class="risibank-navigation-button risibank-hide-when-search" data-nav="search" href="javascript:">\n                        <i class="fas fa-search"></i>\n                    </a>\n                    <input id="' + i.HTML_SEARCH_INPUT_ID + '" class="risibank-navigation-submenu form-control" type="text" placeholder="Appuyer sur entrer pour valider" onkeydown="displayRisitasOnEnter()">\n                    <li role="button" id="risiback" onclick="displayRisitas()" class="ml-3 risibank-navigation-submenu risibank-navigation-return">\n<a href="javascript:load"><i class="fas fa-arrow-right"></i></a></li>\n                </li>                \n                <li class="nav-item risibank-navigation risibank-hide-when-search" data-nav="views">\n                    <a class="risibank-navigation-button" data-nav="views" href="javascript:">\n                        Populaire\n                    </a>\n                </li>\n                \n                <li class="nav-item risibank-navigation risibank-hide-when-search" data-nav="trending">\n                    <a class="risibank-navigation-button" data-nav="trending" href="javascript:">\n                        Hot\n                    </a>\n                </li>\n                \n                <li class="nav-item risibank-navigation risibank-hide-when-search" data-nav="tms">\n                    <a class="risibank-navigation-button" data-nav="tms" href="javascript:">\n                        Récent\n                    </a>\n                </li>\n                \n                <li class="nav-item risibank-navigation risibank-hide-when-search" data-nav="random">\n                    <a class="risibank-navigation-button" data-nav="random" href="javascript:">\n                        Hasard\n                    </a>\n                </li>\n            </ul>\n        </div>\n    </div></div> </div></div>\n\n'
            }, {}],
            4: [function(t, e, n) {
                "use strict";
                Object.defineProperty(n, "__esModule", {
...
function displayRisitas() {
    $("#risibank-stickers").css("display", "block");
    $("#risibank-search").css("display", "none");
    $("#risiback").css("display", "none");
}
function hideRisitas() {
